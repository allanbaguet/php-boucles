<?php
$number1 = 0;
// rand permet de générer un chiffre aléatoire -> ici entre 1 et 100
$number2 = rand(1, 100);
?>
<!DOCTYPE html>
<html lang="fr">
...
<body>
    <nav class="navbar navbar-expand-lg bg-body-secondary d-flex">
        <div class="container-fluid">
            <a class="navbar-brand fs-2" href="#">Les boucles</a>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                ...
                <p class="text-center fs-4">Créer deux variables. Initialiser la première à 0 et la deuxième avec un nombre compris en 1 et 100. <br>
        ...
        <div>
            <?php
                while ($number1 < 20) {
                    ...
                    <p> <?php echo 'Le résultat est : ' . $result;
                    $number1++ ?> </p>
                <?php }
            ?>
        </div>
